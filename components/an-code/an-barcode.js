...
exports.code128 = function (ctx, text, option) {
...
var Graphics = function (ctx, option) {
  ...
  this.area = {
    width: option.width - this.padding_width * 2 - this.quiet * 2,
    height: option.height - this.border_size * 2,
    top: this.border_size - 4,
    left: this.padding_width + this.quiet
  }

  this.ctx = ctx
  this.fg = option.frontground
  this.bg = option.background

  // fill background
  this.fillBgRect(0, 0, option.width, option.height)

  // fill center to create border
  this.fillBgRect(0, this.border_size, option.width, option.height - this.border_size * 2)
}
