...
type | String | 'info' | �������Ͷ�Ӧ��ͬ��ɫ��info��success�� warn��error��| ��
...
> show() ������ԭ��������һ����Ϣ��������������һ��option������ Ϊ�˴�ҷ������

> �����������ֱ�ӿ��ԣ�����һ����ǩ�����Զ��ֳ�������

> ����˵��ʧ������typeΪerror���ɹ�����typeΪsuccess�ģ������Ͳ���Ҫд�����ǩ��

#### ֱ��������д����

```
this.$refs.anRef.show("�ɹ�����", {
	type: 'success'
});
this.$refs.anRef.show("��ʧ���ˣ������Ӧ����", {
>>>>>>> 5df3e2602a390e255c6472bd8c311bb7b362d277
	type: 'error'
});
```
